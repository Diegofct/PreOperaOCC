...
- **No edites a mano** `src/features/checklists/plantillas/*.json`, `src/shared/catalogos/presupuesto.json` ni `drizzle/`: se generan (`npm run formatos`, `npm run presupuesto`, `npm run db:generate`).
