...
const estilos = StyleSheet.create({
  ...
  noApto: { fontSize: Texto.pie, fontWeight: '700', color: Estado.noConforme, marginTop: 4 },
  insignia: {
  ...
  insigniaTexto: { fontSize: 11, fontWeight: '800', letterSpacing: 0.5, color: Estado.atencion },
  flecha: { fontSize: 34, color: Colors.light.textSecondary },
